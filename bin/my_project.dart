...
void main() {
  ...
  while (isRunning) {
    ...
    print('Enter 11 to Return a book');
    ...
    switch (input) {
      ...
      case 9:
        ...
        final user = usersController.findUserByName(name);
        if (user == null) {
          print('User does not exist');
          break;
        }
      
        final book = booksController.findBookByTitle(title);
        if (book == null) {
          print('Book does not exist');
          break;
        }
      
        borrowsController.addBorrow(bookTitle: book, userName: user);
        print('Borrow added: User $name borrowed book $title');
        break;
      case 10:  
      ...
      case 11:
        ...
        borrowsController.removeBorrow(title: title);
        break;
      case 0:
        isRunning = false;
        break;
